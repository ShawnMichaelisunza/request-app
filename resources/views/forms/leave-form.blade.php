...
<form action="{{route('l_store')}}" method="POST" class="max-w-md mx-auto">
    @csrf
    ...
    <div class="relative z-0 w-full mb-5 group">
        <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select an
            option</label>
        <select name="status_leave" id="countries"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            <option selected>I would like to apply for</option>
            <option value="Vocation Leave">Vocation Leave</option>
            <option value="Sick Leave">Sick Leave</option>
            <option value="Absent W/O Pay">Absent W/O Pay</option>
            <option value="Maternity/Paternity Leave/Solo Parent">Maternity/Paternity Leave/Solo Parent</option>
        </select>
        @error('status_leave')
        <span class="text-red-500 text-sm my-2">{{ $message }}</span>
        @enderror
    ...
    <div class="grid md:grid-cols-2 md:gap-6">
        <div class="relative z-0 w-full mb-5 group">
            <input type="date" name="l_from" id="floating_phone"
                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                placeholder=" "/>
        ...
        <div class="relative z-0 w-full mb-5 group">
            <input type="date" name="l_to" id="floating_company"
                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                placeholder=" " />
